...
LS_enabled = true;          % true: Lord-Shulman, false: Fourier
...
T_fixed_r_in  = 300;    % constant temperature at r=Ri
T_fixed_r_out = 300;    % ambient temperature for convection at r=Ro (T_inf)
T_fixed_z_left= 300;    % constant temperature at z=0 (if Dirichlet)
T_fixed_z_right=300;    % constant temperature at z=L
h_conv = 100;           % convection coefficient
