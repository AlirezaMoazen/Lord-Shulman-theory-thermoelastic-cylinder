...
for e = 1:NL
    ...
    if porosity_enabled
        ...
        if     e_3 == 0.9361, em1=0.0511; em2=0.0894; em3=0.9675; em4=0.7599; em5=0.7599;
        elseif e_3 == 0.8716, em1=0.1043; em2=0.1827; em3=0.9336; em4=0.7333; em5=0.7333;
        elseif e_3 == 0.8064, em1=0.1602; em2=0.2807; em3=0.8980; em4=0.7056; em5=0.7056;
        elseif e_3 == 0.7404, em1=0.2193; em2=0.3842; em3=0.8604; em4=0.6758; em5=0.6758;
        elseif e_3 == 0.6733, em1=0.2820; em2=0.4940; em3=0.8205; em4=0.6444; em5=0.6444;
        elseif e_3 == 0.6047, em1=0.3493; em2=0.6120; em3=0.7776; em4=0.6107; em5=0.6107;
        else
            error('e_3 is not valid. Must be one of: 0.9361, 0.8716, 0.8064, 0.7404, 0.6733, 0.6047.');
        end
        ...
        for ir = 1:N_r
            ...
            switch Porosity_pattern
                case 1   % O
                    P = 1 - e1*cos(pi*rr/h);
                    P_m = 1 - em1*cos(pi*rr/h);
                case 2   % X
                    P = 1 - e2*(1 - cos(pi*rr/h));
                    P_m = 1 - em2*(1 - cos(pi*rr/h));
                case 3   % UD
                    P = e_3;
                    P_m = em3;
                case 4   % V
                    P = e4*4*cos(pi*rr/(2*h) + pi/4);
                    P_m = em4*2*cos(pi*rr/(2*h) + pi/4);
                case 5   % A
                    P = e5*4*cos(pi*rr/(2*h) - pi/4);
                    P_m = em5*2*cos(pi*rr/(2*h) - pi/4);
                otherwise
