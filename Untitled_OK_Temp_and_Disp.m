...
%%% Type 1 :
 T_UP    = 300 ;  %% Positive z direction
 T_DOWN  = 300 ;  %% Negative z direction
 T_LEFT  = 300 ;  %% Negative r direction
...
% 
% for i=1:M
%     K_U((i*N),1:NM)=C_r_rrNS((i*N),:)+C_r_rzSS((i*N),:);
% end
% for i=1:M
%     K_U((i*N),NM+1:2*NM)=C_z_rrNS((i*N),:)+C_z_rzSS((i*N),:);
% end
% 
% 
% %%%--- Negative z direction
...
%    
% for i=1:N
%     K_U(i,1:NM)=C_r_zzNS(i,:)+C_r_rzSS(i,:);
% end
% for i=1:N
%     K_U(i,NM+1:2*NM)=C_z_zzNS(i,:)+C_z_rzSS(i,:);
% end
% 
% end
% 
...
% 
% for i=1:M
%     K_W((i*N),1:NM)=C_r_rrNS((i*N),:)+C_r_rzSS((i*N),:);
% end
% for i=1:M
%     K_W((i*N),NM+1:2*NM)=C_z_rrNS((i*N),:)+C_z_rzSS((i*N),:);
% end
% 
% 
% %%%--- Negative z direction
...
%    
% for i=1:N
%     K_W(i,1:NM)=C_r_zzNS(i,:)+C_r_rzSS(i,:);
% end
% for i=1:N
%     K_W(i,NM+1:2*NM)=C_z_zzNS(i,:)+C_z_rzSS(i,:);
% end
% 
% end
% 
...
Dlt_T_r_new=zeros(NM,1);
for i=0:(N-1)
    Dlt_T_r_new((i*M+1):(i*M+M),1) = Dlt_T_r(1:M,1);
 end
...
Dlt_T_z_new=zeros(NM,1);
for i=0:(M-1)
    Dlt_T_z_new((i*N+1):(i*N+N),1) = Dlt_T_z(1:N,1);
end
...
% 
% for i=0:(M-1)
%     known_Dlt_T_r((i*N+1),:)=J_8_p(1,1)*Dlt_T_r(i+1,1)-p_i;
% end
% 
% 
% %%%--- Positive r direction 
% 
% for i=1:M
%     known_Dlt_T_r((i*N),:)=J_8_p(1,1)*Dlt_T_r(i,1);
% end
% 
% 
% %%%--- Negative z direction
...
%  
% for i=1:N
%     known_Dlt_T_r(i,:)=J_8_p(1,1)*Dlt_T_z(i,1);
% end
% 
% % known_Dlt_T_r(1:N,:)=0;
% 
...
%     
% for i=(NM-N)+1:NM
%     known_Dlt_T_r(i,:)=J_8_p(1,1)*Dlt_T_z_new(i,1);
% end
% 
% % known_Dlt_T_r((NM-N)+1:NM,:)=0;
% 
...
% 
% for i=1:M
%     known_Dlt_T_z((i*N),:)=J_8_p(1,1)*Dlt_T_r(i,1);
% end
% 
% 
% %%%--- Negative z direction
...
%  
% for i=1:N
%     known_Dlt_T_z(i,:)=J_8_p(1,1)*Dlt_T_z(i,1);
% end
% 
% % known_Dlt_T_z(1:N,:)=0;
% 
...
%     
% for i=(NM-N)+1:NM
%     known_Dlt_T_z(i,:)=J_8_p(1,1)*Dlt_T_z_new(i,1);
% end
% 
% % known_Dlt_T_z((NM-N)+1:NM,:)=0;
% 
