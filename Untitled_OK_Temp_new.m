...
%      r(i)=(0.5*(1-cos((i-1)*pi/(N-1)))+R_i)*(R_o-R_i);
...
%%% Type 1 :
 T_UP    = 600 ;  %% Positive z direction
 T_DOWN  = 600 ;  %% Negative z direction
...
% 
% for i=0:(M-1)
%     known_Dlt_T_r((i*N+1),:)=J_8*Dlt_T_r(i+1,1)-p_i;
% end
% 
% 
% %%%--- Positive r direction 
% 
% for i=0:(M-1)
%     known_Dlt_T_r((i*N+1),:)=J_8*Dlt_T_r(i+1,1);
% end
% 
% 
% %%%--- Negative z direction
...
%  
% for i=1:N
%     known_Dlt_T_z(i,:)=J_8*Dlt_T_z(i,1);
% end
% 
% known_Dlt_T_z(1:N,:)=0;
% 
...
%     
% for i=(NM-N):NM
%     known_Dlt_T_z(i,:)=J_8*Dlt_T_z_new(i,1);
% end
% 
% known_Dlt_T_z((NM-N):NM,:)=0;
% 
...
% for i=1:M
%     Dlt_T_r_new(N*(i-1)+1,1) = Dlt_T_r(i,1);
% end
% 
% Dlt_T_r_new;
% % Dlt_T_r_new = reshape(Dlt_T_r_new,N,M)
...
% for i=1:N
%     Dlt_T_z_new(M*(i-1)+1,1) = Dlt_T_z(i,1);
% end
% 
% Dlt_T_z_new;
% % Dlt_T_z_new = reshape(Dlt_T_z_new,N,M)
