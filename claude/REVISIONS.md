...
| `CHAPTER5_conclusions_FA/EN` (+ docx) | **DONE (R1, refreshed in place)** | conclusions + future work; numbers re-aligned to R4.4 (overshoot/clamping/aspect/Gaussian framing corrected) after the `chapter_stats.csv` regeneration fix (§7) |
