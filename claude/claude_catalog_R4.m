%% claude_catalog_R4.m — QUANTITY CATALOG for choosing chapter-4 figures (B&W)
%  REVISION 4 of the catalog. R4 REPLACES the weight-fraction zoom study
%  (D2_GPL_fill) from the old 2-4% band to the low fractions
%  W = 0.1 / 0.3 / 0.5 / 0.9 / 1.5 %  (cases D3_W_001..015, run by v6).
%  Everything else is identical to R3 (frozen). R3 kept the 2-4% mapping.
