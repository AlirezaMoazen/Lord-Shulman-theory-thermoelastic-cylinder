%% claude_catalog_R4_color.m — QUANTITY CATALOG (COLOR), revision 4
%  Color companion to claude_catalog_R4.m.
%  REVISION 4 REPLACES the weight-fraction zoom study (D2_GPL_fill) from the
%  old 2-4% band to the low fractions W = 0.1 / 0.3 / 0.5 / 0.9 / 1.5 %
%  (cases D3_W_001..015, run by v6). Everything else identical to R3 (frozen).
%  --- R3 heritage (unchanged in R4) ---
%  R1 = frozen 9-panel; R2 = two-part + smoothed.
