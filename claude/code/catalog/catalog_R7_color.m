%% catalog_R7_color.m — COLOR 4-panel Chapter-4 figures
%  Same studies and dimensionless maps as the black-and-white catalog script,
%  but with a colour style set; output goes to figures_ch4_color/. Used for
%  the colour docx of Chapter 4.
