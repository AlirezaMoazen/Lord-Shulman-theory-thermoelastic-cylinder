%% catalog_R7_full.m — FULL-COMPONENT Chapter-4 catalog (new geometry)
%  Companion to the 4-panel Chapter-4 catalog script. This one shows EVERY
...
%  Dimensionless convention (app10041397 / Heydarpour):
...
%  using the strainprof/dqA helper functions below, which work for any pattern.
...
%% ---- helpers (strainprof, dqA, curve, fin) ----
