%% claude_catalog_bestworst.m — best/worst GPL x porosity combinations (Prom 5, item 2)
%  Author request: one 4-panel figure that overlays the best and worst combinations
%  in BOTH thermal and mechanical terms, against the UD-UD reference, drawn from the
%  25-combination data (H_<GPL>_<Por>.mat). Extremes (final outer-surface T* and peak
...
%  Same 4-panel format & Heydarpour convention as claude_catalog_R6; title-free
%  (Prom.5); legend kept. B&W (-> figures_ch4_bw) and colour (-> figures_ch4_color).
%  New revision file; changes no earlier catalog or the solver.
