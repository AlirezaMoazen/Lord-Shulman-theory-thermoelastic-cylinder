%% catalog_matrix25_4panel_R2.m — all 25 GPL x porosity combinations in ONE 4-panel figure
%  The full 5x5 GPL x porosity interaction set (25 cases) overlaid in the
%  standard Chapter-4 4-panel format, instead of the 5x5 grid-of-subplots
%  view (catalog_R6_extras) or the per-porosity unpacking
%  (catalog_gplpor). Same 4 quantities and display standard as
%  catalog_bestworst.m:
