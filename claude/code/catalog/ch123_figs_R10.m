%% ========================================================================
%  ch123_figs_R10.m  —  schematic figures for thesis chapters 2-3
%  ------------------------------------------------------------------------
...
Pm.V  = 1*em4*cos(pi*zet/2 + pi/4) + em3/2;           % max at INNER face
Pm.A  = 1*em5*cos(pi*zet/2 - pi/4) + em3/2;           % max at OUTER face
...
% shown faithfully so the schematic represents the actual model.
...
exportgraphics(fig,fullfile(outdir,'porosity_patterns_schematic_R9.png'),'Resolution',300);
close(fig); fprintf('done: porosity_patterns_schematic_R9.png\n');
