%% ========================================================================
%  ch123_figs_R9.m  —  schematic figures for thesis chapters 2-3
%  ------------------------------------------------------------------------
...
Pm.V  = 1.2*em4*cos(pi*zet/2 + pi/4) + 0.5;           % max at INNER face
Pm.A  = 1.2*em5*cos(pi*zet/2 - pi/4) + 0.5;           % max at OUTER face
...
exportgraphics(fig,fullfile(outdir,'porosity_patterns_schematic_R8.png'),'Resolution',300);
close(fig); fprintf('done: porosity_patterns_schematic_R8.png\n');
