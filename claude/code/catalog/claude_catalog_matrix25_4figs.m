%% claude_catalog_matrix25_4figs.m — all 25 GPL x porosity combinations, as 4 SEPARATE figures
%  Author request (2026-08-25): same content as claude_catalog_matrix25_4panel.m
%  (that one kept frozen) but split into 4 standalone figures, one per
%  quantity, so each is full-size and more legible than a 2x2 panel:
...
%  B&W -> figures_ch4_bw, colour -> figures_ch4_color. New file; changes
%  no earlier catalog or the solver.
