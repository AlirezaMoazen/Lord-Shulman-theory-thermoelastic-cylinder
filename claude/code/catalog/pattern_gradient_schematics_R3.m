%% pattern_gradient_schematics_R3.m — GPL & porosity patterns as gradient-shaded layer wedges
...
%  Same reference geometry/formulas as ch123_figs.m (frozen source):
...
%% ---- reference geometry (frozen, matches ch123_figs.m) ----
...
zlay = ((1:NL)'-4)/NL;                      % 7 layer-centre coords, same convention as ch123_figs.m
Pm.UD = em3*ones(NL,1);
...
%% ---- draw porosity gradient figure (GPL gradient figure written separately, unaffected here) ----
...
disp('DONE: porosity_pattern_gradient_R2.png');
