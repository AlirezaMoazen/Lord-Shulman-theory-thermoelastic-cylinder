%% ========================================================================
%  claude_T2_5_spatial_methods.m — SPATIAL DISCRETIZATION COMPARISON (T2.5)
%  ------------------------------------------------------------------------
%  Revision of claude_T2_4_spatial_methods.m (T2_4 kept frozen). Change
%  (author request, figure styling only — no numeric change):
%    + connecting lines removed from the data series — markers only
%      (slope-2 dotted reference line kept).
...
%  revision's output supersedes T2_4's on the same filenames.
%  ========================================================================
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== T2.5: SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
