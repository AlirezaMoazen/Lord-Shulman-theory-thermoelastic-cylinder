%% ========================================================================
%  T4_4_axial_methods.m — AXIAL SPATIAL DISCRETIZATION COMPARISON
%  ------------------------------------------------------------------------
%  Axial-direction companion to T2_10_spatial_methods.m (the radial
%  benchmark). T2's benchmark is a radial annulus (Bessel exact solution,
%  no z-dependence), so this is a genuinely separate 1-D AXIAL benchmark
%  with its own exact solution:
%
...
%
%  Same five methods and display standard as the radial comparison
%  (first-edition palette, white-face markers, slope-2 dotted reference,
%  capped y-axis, legend top-right). Same Newmark march (dt = 0.01 s) so
%  the error at t = 10 s is the SPATIAL (axial) error of each method.
%  Cartesian weak form for FEM (weight 1, no r-weighting) and no 1/r term
%  in the strong-form operators. Output -> results_extensions\ (figure
%  T4_axial_convergence + table); independent of the solver campaign files.
%  ========================================================================
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== AXIAL SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
...
%% ---- figure (same display standard as the radial comparison) -----------
