%% catalog_relax_finer_N35_color_R2.m — color C_relaxation 4-panel at N_r=35
%  Color mirror of catalog_relax_finer_N35_R2.m (B&W), same
%  relationship as catalog_R6.m / catalog_R6_color.m: same
%  style/legend convention as the official color 4-panel
%  (catalog_R6_color.m's STY: blue/orange, solid lines, white-face
%  markers). Plots only Fourier + tau*=0.15 (the two cases under active
%  investigation), not all 4 relaxation-time cases. Reads the finer-mesh
%  (N_r=35) diagnostic data in param_studies_relax_finer\. Not part of the
%  official campaign; output kept in its own folder.
...
% COLOUR style set (matches catalog_R6_color.m exactly, first 2 entries)
