%% ========================================================================
%  claude_T2_3_spatial_methods.m — SPATIAL DISCRETIZATION COMPARISON (T2.3)
%  ------------------------------------------------------------------------
%  Revision of claude_T2_2_spatial_methods.m (T2_2 kept frozen). Changes
%  (author request, figure styling only — no numeric change):
%    + legend moved from 'southwest' to 'northeast'
%    + removed the "DQM (uniform) diverges for N >= 41" text annotation
...
%  revision's output supersedes T2_2's on the same filenames.
%  ========================================================================
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== T2.3: SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
