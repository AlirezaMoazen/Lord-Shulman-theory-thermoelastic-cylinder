%% ========================================================================
%  claude_T2_6_spatial_methods.m — SPATIAL DISCRETIZATION COMPARISON (T2.6)
%  ------------------------------------------------------------------------
%  Revision of claude_T2_5_spatial_methods.m (T2_5 kept frozen). Change
%  (author request, figure styling only — no numeric change):
%    + connecting lines restored between markers (author wants the
%      first-edition look: colored lines + hollow markers together).
...
%  revision's output supersedes T2_5's on the same filenames.
%  ========================================================================
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== T2.6: SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
