%% ========================================================================
%  claude_T2_9_spatial_methods.m — SPATIAL DISCRETIZATION COMPARISON (T2.9)
%  ------------------------------------------------------------------------
%  Revision of claude_T2_7_spatial_methods.m (T2_7 kept frozen). Author
%  request: revert to T2.7's node sweep (T2.8's densified-DQM/extended-FEM
%  sweep not wanted for the shipped figure) but keep the x-axis label fix
%  — drop "N" ("number of radial points N" -> "number of radial points").
%  Everything else identical to T2.7: same DQM node sweep to N=201, same
%  exact Bessel-series reference, same Newmark time march (dt = 0.01 s).
%  Output goes to results_extensions\.
%  ========================================================================
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== T2.9: SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
