%% ========================================================================
%  claude_T4_1_axial_methods.m — AXIAL SPATIAL DISCRETIZATION COMPARISON (T4.1)
%  ------------------------------------------------------------------------
%  Revision of claude_T4_axial_methods.m (T4 kept frozen). Change (author
%  request, figure only — no numeric change): y-axis floor lowered from
%  1e-5 to 1e-6 so the lowest DQM(uniform) point (N=31, err~7.5e-6) is no
%  longer clipped off the bottom of the plot.
%  ------------------------------------------------------------------------
...
%% ---- sweeps -------------------------------------------------------------
fprintf('===== T4.1: AXIAL SPATIAL METHOD CONVERGENCE incl. FEM (error at t=10 s) =====\n');
