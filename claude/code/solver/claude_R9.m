%% ========================================================================
%  claude_R9.m  —  DYNAMIC THERMOELASTIC ANALYSIS (MULTI-THEORY)  [PERFORMANCE REVISION]
...
%
%   VALIDATION (2026-08-06): claude_R9_compare.m diffed R8 vs R9 output
...
%   claude_R9_check_benchmark1.m independently re-ran literature benchmark
...
gam = 0.5;  bet = 0.25;
out_name = 'Results_claude_R9.mat';    % output file for saved results
