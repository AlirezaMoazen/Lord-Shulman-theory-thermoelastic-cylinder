...
![Figure 4-19: Effect of thermo-mechanical coupling — fully coupled versus uncoupled energy equation [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/I_coupling.png){width=6in}

Figure 4-19 compares the fully coupled model with the uncoupled one (the
...
![Figure 4-20: Effect of the outer-surface convection coefficient h_c = 10 / 100 / 1000 W/m²K [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/J_convection.png){width=6in}

Figure 4-20 examines the outer-surface convection coefficient for h_c = 10, 100
...
![Figure 4-21: Effect of the wall thickness, radius ratio R_o/R_i = 1.25 / 1.5 / 2.0 (inner radius fixed at 1 m) [L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/K_thickness.png){width=6in}

Figure 4-21 compares three cylinders with radius ratios R_o/R_i = 1.25, 1.5 and
...
![Figure 4-22: Response to a Gaussian thermal shock — Lord–Shulman versus Fourier [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, P_i=50 MPa, simply supported]](figures_ch4_color/M_gauss_shock.png){width=6in}
...
Fourier theories (Figure 4-22). The loading exposes the essential difference
...
![Figure 4-23: Comparison of the generalized thermoelasticity theories — Fourier, Lord–Shulman, dual-phase-lag and Green–Naghdi III [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/T3_theories.png){width=6in}
...
Figure 4-23, the peak mid-point temperatures order as Fourier 0.950 < DPL 0.956 <
