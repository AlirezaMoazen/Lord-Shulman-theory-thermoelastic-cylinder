...
![Figure 4-1: Radial-node convergence — hoop-stress and temperature profiles for N_r = 7…15 [N_z=11, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/conv_Nr.png){width=6in}
...
![Figure 4-2: Axial-node convergence — profiles for N_z = 5…15 [N_r=15, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/conv_Nz.png){width=6in}
...
![Figure 4-3: Layer convergence — profiles for N_L = 3…15 [N_r=15, N_z=11, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/conv_NL.png){width=6in}
...
![Figure 4-4: Verification (mechanical) — inner-surface dimensionless radial displacement of the present solver against Malekzadeh & Heydarpour (2012) and an independent ANSYS solution [thick cylinder under internal pressure step]](figures_ch4_bw/bench1_U.png){width=6in}

**4-5**

![Figure 4-5: Verification (thermal) — transient temperature profiles of the present DQM+Newmark solver against the exact Bessel-series solution at t = 2, 10 and 40 s](figures_ch4_bw/bench2_T_profiles.png){width=6in}
...
![Figure 4-6: Effect of the GPL distribution pattern (UD, O, X, V, A) on the mid-point T* and U* histories and the final T* and Σθθ profiles [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/A_GPL_patterns.png){width=6in}
...
![Figure 4-7: Effect of the porosity distribution pattern (UD, O, X, V, A), GPL uniform [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/B_porosity_patterns.png){width=6in}
...
![Figure 4-8: Effect of the porosity level e_m3 = 0.9675 / 0.8604 / 0.7776 [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, UD, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/E_porosity_level.png){width=6in}
...
![Figure 4-9: Effect of the GPL weight fraction (low range) W = 0.1 / 0.3 / 0.5 / 0.9 / 1.5 % [R_o/R_i=1.5, L=2.1 m, N_L=7, UD, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/D_wt_low.png){width=6in}
...
![Figure 4-10: Effect of the GPL weight fraction (high range) W = 1 / 2 / 4 / 8 % [R_o/R_i=1.5, L=2.1 m, N_L=7, UD, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/D2_wt_high.png){width=6in}
...
![Figure 4-11: Effect of the platelet length-to-width aspect ratio a/b = 1.0 / 1.67 / 2.67 [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/O_aspect_ab.png){width=6in}
...
![Figure 4-12: Effect of the platelet width-to-thickness aspect ratio b/t = 500 / 1000 / 2000 [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/P_aspect_bt.png){width=6in}
...
![Figure 4-13: Effect of the relaxation time — Fourier (τ*=0) and Lord–Shulman τ* = 0.04 / 0.15 / 0.44 [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, P_i=50 MPa, simply supported]](figures_ch4_bw/C_relaxation.png){width=6in}
...
![Figure 4-14: Effect of the end supports — simply supported (S-S), mixed (S-C) and clamped (C-C) [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa]](figures_ch4_bw/F_end_BC.png){width=6in}
...
![Figure 4-15: Effect of the internal pressure P_i = 0 / 10 / 50 / 100 MPa [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, simply supported]](figures_ch4_bw/G_pressure.png){width=6in}
...
![Figure 4-16: Effect of the cylinder length L = 1 / 2.1 / 5 / 10 m [R_i=1, R_o=1.5, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/Q_length.png){width=6in}
...
![Figure 4-17: Full 25-case GPL × porosity matrix — through-wall dimensionless temperature T*(ξ) for every pattern pair (rows: GPL pattern; columns: porosity pattern) [reference: W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/matrix25_Tstar.png){width=6in}
...
![Figure 4-18: Full 25-case GPL × porosity matrix — hoop-stress profile Σθθ(ξ) for every pattern pair (rows: GPL pattern; columns: porosity pattern) [reference: W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/matrix25_Sigma_thth.png){width=6in}
...
![Figure 4-19: GPL pattern comparison (UD, O, X, V, A) at uniform (UD) porosity [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, UD porosity, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/gplpor_porUD.png){width=6in}

**4-20**

![Figure 4-20: GPL pattern comparison (UD, O, X, V, A) at O-type porosity [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, O porosity, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/gplpor_porO.png){width=6in}

**4-21**

![Figure 4-21: GPL pattern comparison (UD, O, X, V, A) at X-type porosity [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, X porosity, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/gplpor_porX.png){width=6in}

**4-22**

![Figure 4-22: GPL pattern comparison (UD, O, X, V, A) at V-type porosity [R_i=1, R_o=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, V porosity, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/gplpor_porV.png){width=6in}
...
![Figure 4-25: Effect of thermo-mechanical coupling — fully coupled versus uncoupled energy equation [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/I_coupling.png){width=6in}
...
![Figure 4-26: Effect of the outer-surface convection coefficient h_c = 10 / 100 / 1000 W/m²K [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/J_convection.png){width=6in}
...
![Figure 4-27: Effect of the wall thickness, radius ratio R_o/R_i = 1.25 / 1.5 / 2.0 (inner radius fixed at 1 m) [L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/K_thickness.png){width=6in}
...
![Figure 4-28: Response to a Gaussian thermal shock — Lord–Shulman versus Fourier [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, P_i=50 MPa, simply supported]](figures_ch4_bw/M_gauss_shock.png){width=6in}
...
![Figure 4-29: Spatial-discretization convergence on the transient-conduction benchmark: maximum error versus number of radial nodes N for DQM (Chebyshev and uniform), 2nd-order FDM, and linear/quadratic FEM; the dotted line marks slope -2 (second-order convergence)](figures_ch4_bw/spatial_convergence.png){width=6in}
## 4-20. Comparison of the generalized thermoelasticity theories

**4-30**

![Figure 4-30: Comparison of the generalized thermoelasticity theories — Fourier, Lord–Shulman, dual-phase-lag and Green–Naghdi III [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_bw/T3_theories.png){width=6in}
