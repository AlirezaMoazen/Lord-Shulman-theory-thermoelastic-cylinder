...
![Figure 4-24: Effect of thermo-mechanical coupling — fully coupled versus uncoupled energy equation [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/I_coupling.png){width=6in}
...
![Figure 4-25: Effect of the outer-surface convection coefficient h_c = 10 / 100 / 1000 W/m²K [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/J_convection.png){width=6in}
...
![Figure 4-26: Effect of the wall thickness, radius ratio R_o/R_i = 1.25 / 1.5 / 2.0 (inner radius fixed at 1 m) [L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/K_thickness.png){width=6in}
...
![Figure 4-27: Response to a Gaussian thermal shock — Lord–Shulman versus Fourier [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, P_i=50 MPa, simply supported]](figures_ch4_color/M_gauss_shock.png){width=6in}
...
![Figure 4-28: Comparison of the generalized thermoelasticity theories — Fourier, Lord–Shulman, dual-phase-lag and Green–Naghdi III [R_o/R_i=1.5, L=2.1 m, N_L=7, W_GPL=0.3%, e_m3=0.8604, τ*=0.15, P_i=50 MPa, simply supported]](figures_ch4_color/T3_theories.png){width=6in}
