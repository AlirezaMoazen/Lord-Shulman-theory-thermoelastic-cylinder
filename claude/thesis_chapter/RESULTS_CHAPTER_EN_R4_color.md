...
![Time-step convergence; steps up to 2 s are converged while 5 s produces a spurious overshoot.](figures_ch4_color/conv_dt.png){width=6in}
...
![L2 hoop-profile error versus problem size N_dof, refined one direction at a time; the axial direction is binding.](figures_ch4_color/conv_master.png){width=6in}
