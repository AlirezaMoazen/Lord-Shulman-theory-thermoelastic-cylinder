...
% A_r_G_new1=zeros(NM*NL);
A_r_G_new2=zeros(NM*NL);
...
%  A_r_G_new1((i*NM+1):(i*NM+NM),(i*NM+1):(i*NM+NM)) = A_r_new(1:NM,1:NM);

 
 
 A_r_G_new1((1):(NM),(i*NM+1):(i*NM+NM)) = A_r_new(1:NM,1:NM);

 
%  A_r_G_new2((i*NM+1):(i*NM+NM),:) = A_r_G_new1(1:NM,1:NM);
 ...
 for i=0:NL-1
     ...
     A_r_G_new2((i*NM+1):(i*NM+NM),1:NM*NL) = A_r_G_new1(1:NM,1:NM*NL);
     
 end
 
 for i=0:NL-1
     for j=0:M-1
         A_r_G_new3((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) = A_r_G_new2((i*NM+1):(i*NM+N),:);
     end
 end
...
B_r_G_new1((i*NM+1):(i*NM+NM),(i*NM+1):(i*NM+NM)) = B_r_new(1:NM,1:NM);
 ...
 for i=0:NL-1
     for j=0:M-1
%          B_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) = B_r_G_new1((j*NM+1):(j*NM+N),:)
%          B_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) =   i+1 ;
         B_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),(i*N+1):(i*N+N)) = B_r_G(:,(i*N+1):(i*N+N))
%          A_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),(i*NM+j*N+1):(i*NM+j*N+N)) = A_r(1:N,1:N);
     end
 end
...
for i=0:NL-1
    ...
    A_z_G_new1((i*NM+1):(i*NM+NM),(i*NM+1):(i*NM+NM)) = A_z_new(1:NM,1:NM);
...
for i=0:NL-1
     for j=0:M-1
%          A_z_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) = A_z_G_new1((i*NM+1):(i*NM+N),:)
%          A_z_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) = A_z_G_new1((i*NM+j*N+1):(i*NM+j*N+N),:);
         A_z_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),:) =   i+1 ;
%          B_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),(i*N+1):(i*N+N)) = B_r_G(:,(i*N+1):(i*N+N))
%          A_r_G_new((j*N*NL+i*N+1):(j*N*NL+i*N+N),(i*NM+j*N+1):(i*NM+j*N+N)) = A_r(1:N,1:N);
     end
 end
...
for i=0:NL-1
    ...
    B_z_G_new1((i*NM+1):(i*NM+NM),(i*NM+1):(i*NM+NM)) = B_z_new(1:NM,1:NM);
